...
storms_df <- select(storms_df, BGN_DATE, EVTYPE, FATALITIES, INJURIES, STATE) %>%
  mutate(
...
The code which created this report can also be found on GitHub: https://github.com/alex23lemm/RepData_PeerAssessment2

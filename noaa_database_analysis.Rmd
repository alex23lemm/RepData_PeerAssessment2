...
* We will group the dataset by event type and calculate the the total number of observations which belong to each event type. 
...
print(xtable(storms_by_evtype_df[1:50, ], 
             caption = "The 46 event types with the highest obervation percentage contribution", digits = 7), type = 'html', include.rownames = FALSE)

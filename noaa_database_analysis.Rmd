...
We decide to include the  69 event types which contribute the most to the overall amount of observations. Those 65 event types make up for 99,5 % of the total amount of observations. 

This is equivalent to include all event types which contribute more than 100 observations to the dataset.

```{r}

print.data.frame(filter(storms_by_evtype_df, rank == 69))

...
print(xtable(tstm_subset_df[743:823, ], 
             caption = "Examples of event type name modifications"), type = 'html', include.rownames = FALSE)
...
print(xtable(storms_by_evtype_df[1:47, ], 
             caption = "The 47 event types with the highest observation percentage contribution", digits = 7), type = 'html', include.rownames = FALSE)

# Storm events have minor impact on population health (comming soon)

## Synopsis


In thec first chapter _Data Processing_ of this report we will derive a processed dataset based on the raw data. Based on the processed dataset, we will conduct a detailed data analysis in the subsequent chapter _Results_.
...
The general pattern which the smoother highlights in the time series plot above, can in parts be explained with the progression of available observations per year:
...
__Note__: Based on time constraints I was not able to answer this question of the assignment. 
